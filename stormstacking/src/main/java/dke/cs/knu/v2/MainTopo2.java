...
public class MainTopo2 {
    private static Log LOG = LogFactory.getLog(MainTopo2.class);
    ...
    public void topoMain(String[] args) throws InterruptedException, NotAliveException, TException {
        ...
        Level0Bolt level0Bolt = new Level0Bolt(modelPath);
        Level1Bolt level1Bolt = new Level1Bolt(modelPath);
        ...
        builder.setBolt("level0-bolt", level0Bolt, parameters.get(1)).shuffleGrouping("kafka-spout");
        builder.setBolt("level1-bolt", level1Bolt, parameters.get(2)).shuffleGrouping("level0-bolt");
